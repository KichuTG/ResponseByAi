...
async def start_command(client, message):
    ...
    welcome_message = (
        ...
        "🤖 I'm your personal AI assistant, crafted with love by @DramaShip .\n\n"
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 ᴜᴘᴅᴀᴛᴇ", url="https://t.me/Dramaship"),
         InlineKeyboardButton("🛠️ sᴜᴘᴘᴏʀᴛ", url="https://t.me/DramaChats")]
    ])

    await client.send_photo(chat_id=message.chat.id, photo="https://envs.sh/otM.jpg", caption=welcome_message, reply_markup=keyboard)
